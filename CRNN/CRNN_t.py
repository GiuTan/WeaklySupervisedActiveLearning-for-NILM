...
from CRNN.pooling_layer import LinSoftmaxPooling1D
from CRNN.losses import binary_crossentropy, binary_crossentropy_weak
from CRNN.metrics import custom_f1_score
...
def CRNN_construction(window_size, weight, lr=0.0, classes=0, drop_out=0.1, kernel=1, num_layers=1, gru_units=1,
                      cs=False, path='', only_strong=False):
